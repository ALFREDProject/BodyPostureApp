...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(eu.alfred.bodypostureapp.R.layout.activity_main);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(eu.alfred.bodypostureapp.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == eu.alfred.bodypostureapp.R.id.action_settings) {
            return true;
        }
    ...
    public void onBtnSaveClick(View view) {
        EditText nameText = (EditText)this.findViewById(eu.alfred.bodypostureapp.R.id.nameText);
...
*/
    ...
    private void setText(String text){
        ...
        TextView nameText = (TextView) this.findViewById(eu.alfred.bodypostureapp.R.id.resultLabel);
    ...
    private void sendNotification(String notificationDetails) {
        ...
        builder.setSmallIcon(eu.alfred.bodypostureapp.R.drawable.ic_launcher)
                // In a real app, you may want to use a library like Volley
                // to decode the Bitmap.
                .setLargeIcon(BitmapFactory.decodeResource(getResources(),
                        eu.alfred.bodypostureapp.R.drawable.ic_launcher))
                .setColor(Color.BLUE)
